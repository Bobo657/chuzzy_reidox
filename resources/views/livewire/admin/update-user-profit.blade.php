<div class="modal fade" wire:ignore.self id="update-profit-form" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title m-0">Update User Profit</h6>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="update" class="btn btn-de-primary btn-sm">
                Save
                </button>
