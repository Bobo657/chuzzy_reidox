            ...
            <div class="row">
                ...
                <div class="col-lg-6 pl-60 md-pl-15">
                    <div class="sec-title">
                        ...
                        <p class="margin-0 pt-15">We have digital asset and currencies designed to work as a medium of exchange which uses strong cryptography to secure financial transactions, control the creation of additional units, and to verify the transfer of assets. Growing incredibly in popularity in recent years, cryptocurrencies have become the go-to investment option for many. </p>
                        
                        <p class="margin-0 pt-10">With an ever-growing selection of cryptocurrencies added to the platform, offering balanced exposure and managed by {{ config('app.name') }} expert investment committee. {{ config('app.name') }} presents many options for those who wish to trade and invest in the cryptocurrency market.</p>
                    </div>
                    <!-- Counter Section End -->
