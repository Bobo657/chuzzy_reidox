                            ...
                            <div class="card mb-0 border-0">
                                ...
                                <div class="card-body pt-0">  
                                    ...
                                    <input type="hidden" name="token" value="{{ $request->route('token') }}">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="Confirmpassword">Confirm Password Confirmation</label>
                                            <input type="password" class="form-control" name="password_confirmation" :value="old('password_confirmation')"  placeholder="Enter Password Confirmation">
                                        </div><!--end form-group-->  
    
                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100" type="submit"> Reset Password <i class="fas fa-sign-in-alt ms-1"></i></button>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->                           
                                    </form><!--end form-->
